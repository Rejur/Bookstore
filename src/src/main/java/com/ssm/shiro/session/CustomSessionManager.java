package com.ssm.shiro.session;


import com.ssm.UserOnline.UserOnlineBo;
import com.ssm.model.Users;
import com.ssm.utils.LoggerUtils;
import com.ssm.utils.StringUtils;
import com.ssm.shiro.CustomShiroSessionDAO;
...
public class CustomSessionManager {
	 ...
	 * session status 
	 */
	public static final String SESSION_STATUS ="ssm-online-status";
	...
	private UserOnlineBo getSessionBo(Session session){
		...
		if(obj instanceof SimplePrincipalCollection){
			...
			if(null != obj && obj instanceof Users){
				//存储session + user 综合信息
				UserOnlineBo userBo = new UserOnlineBo((Users)obj);
				//最后一次和系统交互的时间
