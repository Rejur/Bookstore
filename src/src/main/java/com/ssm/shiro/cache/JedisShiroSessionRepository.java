package com.ssm.shiro.cache;

import com.ssm.utils.LoggerUtils;
import com.ssm.utils.SerializeUtil;
import com.ssm.shiro.session.CustomSessionManager;
import com.ssm.shiro.session.SessionStatus;
import com.ssm.shiro.session.ShiroSessionRepository;
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    public static final String REDIS_SHIRO_SESSION = "ssm-shiro-demo-session:";
    //这里有个小BUG，因为Redis使用序列化后，Key反序列化回来发现前面有一段乱码，解决的办法是存储缓存不序列化
    public static final String REDIS_SHIRO_ALL = "*ssm-shiro-demo-session:*";
