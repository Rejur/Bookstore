package com.ssm.shiro.token.manager;

import com.ssm.model.Users;
import com.ssm.utils.SpringContextUtil;
import com.ssm.shiro.session.CustomSessionManager;
import com.ssm.shiro.token.SampleRealm;
import com.ssm.shiro.token.ShiroToken;
...
public class TokenManager {
	...
	public static Long getUserId(){
		return getToken()==null?null:getToken().getId().longValue();
	}
	/**
	...
	public static Users login(Users user,Boolean rememberMe){
		ShiroToken token = new ShiroToken(user.getLoginid(), user.getLoginpwd());
