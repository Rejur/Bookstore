...
<form action="/aBooks/modifybook" name="a" method="post" enctype="multipart/form-data" >
    <table>
        ...
        <tr>
            <th>封面</th>
            <td>
                <input type="file" name="imgISBN" accept="image/*" />
            </td>
        </tr>
        ...
        <tr>
            <th>定价</th>
            <td>
                <input type="text"  name="UnitPrice" value="${cb.unitprice}"/>
            </td>
        </tr>
            ...
            <td>
                <select name="PublisherId" id="PublisherId" class="select">
                    ...
                    <c:forEach items="${publishersList}" var="var" varStatus="vs">
                        <c:choose>
                            <c:when test="${var.id == cb.publisherid}">
            ...
            <td>
                <select name="CategoryId" id="CategoryId" class="select">
                    ...
                    <c:forEach items="${categoriesList}" var="var" varStatus="vs">
                        <c:choose>
                            <c:when test="${var.id == cb.categoryid}">
                                <option value="${var.id}" selected="selected">${var.name}</option>
                            </c:when>
                            <c:otherwise>
                                <option value="${var.id}">${var.name}</option>
        ...
        <tr>
            <th>作者</th>
            <td>
                <input type="text"  name="Author" value="${cb.author}"/>
            </td>
        </tr>
        ...
        <tr>
            <th>ISBN</th>
            <td>
                <input type="text"  name="ISBN" value="${cb.isbn}"/>
            </td>
        </tr>
        ...
        <tr>
            <th>出版日期</th>
            <td>
                <input type="text" name="PublishDate" style="width:70px" onfocus="HS_setDate(this)" value="${cb.publishdate}" >
            </td>
        </tr>
        <tr>
        </tr>
        ...
        <textarea class="ckeditor" cols="80" id="ContentDescription" name="ContentDescription"
                  rows="10" >${cb.contentdescription}</textarea>
            </td>
        </tr>
        ...
        <textarea class="ckeditor" cols="80" id="TOC" name="TOC"
                  rows="10" data-value="">${cb.toc}</textarea>
            </td>
        </tr>
        <tr>
        <input style="visibility: hidden" name="Id" value="${cb.id}"/>
        </tr>
        <tr>
            <td colspan="2">
                <p>
